...
from .syncode.syncode.dfa_mask_store import DFAMaskStore
from .syncode.syncode.parse_result import ParseResult, RemainderState
from .syncode.syncode.parsers.incremental_parser import IncrementalParser, SymbolPosMap
from transformers.cache_utils import DynamicCache
from .trace import Trace
from .syncode.syncode.parsers import create_base_parser, create_parser
...
class IterGen:
    ...
    def update_gen_args(self, **gen_args: dict) -> None:
        ...
        try:
            ...
            # compatible with new transformers versions where _get_logits_warper is replaced by _get_logits_processor
